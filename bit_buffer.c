...
static int bit_buffer_get_bit_value(const bit_buffer *const b, const int bit_in_array);
static void bit_buffer_set_bit_value(bit_buffer *b, const int bit_in_array, const int value);
/* ---------------------- External functions ---------------------- */
...
bit_buffer *bit_buffer_create(const char *const byte_array, const int size)
{
...
int bit_buffer_inspect_bit(const bit_buffer *const b, const int bit_no)
{
	assert(b);
	assert(b->array);
